...
import { usePersistedOpen } from "@/lib/usePersistedOpen";
...
export default function NewsletterSubscribersSection({
  ...
  const [open, setOpen] = usePersistedOpen("zusammen-collapsed-newsletter-subscribers", true);
  const { visible, hiddenCount, showAll, setShowAll } = useShowMore(subscribers, 8);
